...
export const Hero = () => {
  return (
    <section className="bg-black text-white py-[72px] sm:py-24 bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] relative overflow-clip">
      ...
      <div className="container relative">
       ...
       <div className='flex justify-center mt-8'>
         <div className='inline-flex relative'>
            ...
            <Image src={cursorImage} alt='Cursor Image' height={200} width={200} className='absolute top-[108px] left-[-156px] max-md:hidden' />
            <Image src={messageImage} alt='Message Image' height={200} width={200} className='absolute top-[56px] left-[500px] max-md:hidden' />
         </div>
       </div>
